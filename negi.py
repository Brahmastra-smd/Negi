...
TOKEN = '7942096495:AAFxblWwVJLxwzhEhR4g7v3yeitjQmCS9VY'
MONGO_URI = 'mongodb+srv://botplays:botplays@vulpix.ffdea.mongodb.net/?retryWrites=true&w=majority&appName=Vulpix' 
FORWARD_CHANNEL_ID = -1002311207175
CHANNEL_ID = -1002311207175
error_channel_id = -1002311207175
ADMIN_ID = 6485416071  # Replace with your actual Telegram ID
AUTHORIZED_USERS = [6485416071]  # Replace with actual admin user IDs
...
def create_inline_keyboard():
    ...
    button = InlineKeyboardButton(text="OWNER", url="https://t.me/Naitik_bgmi_ddos_father")
    keyboard.add(button)
    return keyboard
...
def broadcast_message(message):
    ...
    if message.from_user.id != 6485416071:
...
def attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*You are not approved to use this bot. \nPlease contact @Naitik_bgmi_ddos_father*", parse_mode='Markdown', reply_markup=create_inline_keyboard())
            return
...
def info_command(message):
    ...
    if user_data:
        ...
        response = "*No account information found. \nPlease contact @Naitik_bgmi_ddos_father*"
...
def owner_command(message):
    bot.send_message(message.chat.id, "*Owner - @Naitik_bgmi_ddos_father*", parse_mode='Markdown', reply_markup=create_inline_keyboard())
...
def canary_command(message):
    ...
    button1 = InlineKeyboardButton(
        ...
        url="https://t.me/Naitik_bgmi_ddos_father")
